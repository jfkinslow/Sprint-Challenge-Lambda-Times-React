...
-   [ ] What are PropTypes used for? Please describe why it's important to type check our data in JavaScript.
        PropTypes are used to make sure that all the properties used match the correct type.
-   [ ] Describe a life-cycle event in React?
        A lifecycle event is an event that occurs throughout the lifecycle of a react app such as componentDidMount
-   [ ] Explain the details of a Higher Order Component?
        Higher order components are components that are wrappers for other components such as withAuth.js in the ReactInstaClone
-   [ ] What are three different ways to style components in React? Explain some of the benefits of each.
        ReactStrap, StyledComponents, and CSS, CSS is used everywhere, Styled components are more react type styles and are more custome than reactstrap, and reactstrap is literally just bootstrap in react component form.
